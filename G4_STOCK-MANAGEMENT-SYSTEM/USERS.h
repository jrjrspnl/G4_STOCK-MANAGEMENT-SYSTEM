...
namespace G4STOCKMANAGEMENTSYSTEM {
    ...
    {
        SqlConnection^ connection = gcnew SqlConnection("Data Source=(localdb)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Jerwin\\Documents\\stock.mdf;Integrated Security=True");
